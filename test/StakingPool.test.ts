...
export function test() {
  describe("StakingPoolClient", () => {
    ...
    it("swapy, golive, CantUnstakeBeforeCliff", async () => {
      const boundPool = await BoundPoolClient.new({
        admin,
        payer,
        client,
    ...
    it("swapy, golive, ammswap, multiple addfees, multiple unstakes without addfees between", async () => {
      const boundPool = await BoundPoolClient.new({
        admin,
        payer,
        client,
    ...
    it("swapy, golive, ammswap, multiple addfees, multiple unstakes with addfees between", async () => {
      const boundPool = await BoundPoolClient.new({
        admin,
        payer,
        client,
    ...
    it("swapy, golive, multiple ammSwaps, multiple addfees, multiple unstakes", async () => {
      const boundPool = await BoundPoolClient.new({
        admin,
        payer,
        client,
