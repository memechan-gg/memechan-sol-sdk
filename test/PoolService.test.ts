...
export function test() {
  describe("PoolService", () => {
    ...
    it("Get a pool for a specific coin", async () => {
      if (sp) {
    ...
    it("Ensure that the staking pools is returning the staking pools stored into BE", async () => {
    ...
    it("Ensure that the live pools is returning the live pools stored into BE", async () => {
      const poolApi = new PoolAPI(BE_URL);
