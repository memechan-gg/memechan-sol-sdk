...
import { payer, DUMMY_TOKEN_METADATA, createMemeChanClient } from "../../common";
import { getTxSize } from "../../../src/util/get-tx-size";
import { getConfig, MemeTicketClient, sleep } from "../../../src";
...
export const createNewTokenAndPoolTx = async () => {
  const { ADMIN_PUB_KEY: admin, TOKEN_INFOS } = await getConfig();
