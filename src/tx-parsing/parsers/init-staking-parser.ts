...
export async function ParseInitStakingInstruction(tx: ParsedTransactionWithMeta, index: number, client: MemechanClient): Promise<InitStakingPoolInstructionParsed | undefined> {
