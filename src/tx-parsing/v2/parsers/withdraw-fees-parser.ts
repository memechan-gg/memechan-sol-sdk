...
export type WithdrawFeesInstructionParsed = {
  sender: PublicKey;
...
export async function parseWithdrawFeesInstruction(
  tx: ParsedTransactionWithMeta,
  index: number,
): Promise<WithdrawFeesInstructionParsed | undefined> {
  ...
  for (const log of tx.meta.logMessages) {
    ...
    if (match) {
      ...
      const withdrawFeesParsed: WithdrawFeesInstructionParsed = {
