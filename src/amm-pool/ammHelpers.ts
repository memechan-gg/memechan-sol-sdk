...
export function findProgramTollAddress(admin: PublicKey, ammProgramId: PublicKey): PublicKey {
  const [programToll] = PublicKey.findProgramAddressSync([Buffer.from("toll"), admin.toBuffer()], ammProgramId);
  return programToll;
}
