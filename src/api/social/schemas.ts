import { z } from "zod";
import { paginatedResultSchema } from "../schemas/token-schemas";
...
const likesResult = paginatedResultSchema(likeResultSchema);
...
export type GetUserLikesResult = z.infer<typeof likesResult>;
