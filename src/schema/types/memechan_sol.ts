    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "orderNum";
            docs: ["max order count"];
            type: "u64";
          },
          {
            name: "depth";
            docs: ["within this range, 5 => 5% range"];
            type: "u64";
          },
          {
            name: "coinDecimals";
          ...
          {
            name: "minSize";
            docs: ["min size 1->0.000001"];
            type: "u64";
          },
          {
            name: "volMaxCutRatio";
            docs: ["vol_max_cut_ratio numerator, sys_decimal_value as denominator"];
            type: "u64";
          },
          {
            name: "amountWave";
            docs: ["amount wave numerator, sys_decimal_value as denominator"];
            type: "u64";
          },
          {
            name: "coinLotSize";
            docs: ["coinLotSize 1 -> 0.000001"];
            type: "u64";
          },
          {
            name: "pcLotSize";
            docs: ["pcLotSize 1 -> 0.000001"];
            type: "u64";
          },
          {
            name: "minPriceMultiplier";
            docs: ["min_cur_price: (2 * amm.order_num * amm.pc_lot_size) * max_price_multiplier"];
            type: "u64";
          },
          {
            name: "maxPriceMultiplier";
            docs: ["max_cur_price: (2 * amm.order_num * amm.pc_lot_size) * max_price_multiplier"];
            type: "u64";
          },
          {
            name: "sysDecimalValue";
            docs: ["system decimal value, used to normalize the value of coin and pc amount"];
            type: "u64";
          },
          {
            name: "fees";
            docs: ["All fee information"];
            type: {
              defined: "RaydiumFees";
            };
          },
          ...
          {
            name: "marketProgram";
            docs: ["market program key"];
            type: "publicKey";
          },
          {
            name: "targetOrders";
            docs: ["target_orders key"];
            type: "publicKey";
          },
          {
            name: "padding1";
